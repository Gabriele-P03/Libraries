        ...
        namespace jpl{
            ...
            namespace _logger{
                ...
                */
                 ...
                 */
                inline void print(const std::string &msg, const LOG_STATUS status){
                ...
                inline void info(const std::string &msg){ jpl::_logger::print(msg, INFO_JPL); }
                inline void error(const std::string &msg){ jpl::_logger::print(msg, ERROR_JPL); }
                inline void warning(const std::string &msg){ jpl::_logger::print(msg, WARNING_JPL); }
                inline void debug(const std::string &msg){ jpl::_logger::print(msg, DEBUG_JPL); }
            }
        } 
    #endif
