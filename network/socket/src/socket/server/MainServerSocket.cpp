...
jpl::_network::_socket::MainServerSocket::MainServerSocket(unsigned int port) : jpl::_network::_socket::MainServerSocket(port, AF_INET, SOCK_STREAM, IPPROTO_TCP){}
jpl::_network::_socket::MainServerSocket::MainServerSocket(unsigned int port, int domain, int type, int protocol) : 
    jpl::_network::_socket::MainSocket(port, domain, type, protocol){
...
void jpl::_network::_socket::MainServerSocket::loopAccept(){
...
void* jpl::_network::_socket::MainServerSocket::startThread(void* instance){
    ((MainServerSocket*)instance)->loopAccept();

    return NULL;
}

int jpl::_network::_socket::MainServerSocket::startLoopAcceptThread(){
    ...
    this->loopAccept();
    /*
    int res = pthread_create(&this->loopAccept_pthread_id, NULL, jpl::_network::_socket::MainServerSocket::startThread, this);
    if(res == 0){
...
bool jpl::_network::_socket::MainServerSocket::isLoopRunning(){
    return this->flagLoop;
}

void jpl::_network::_socket::MainServerSocket::setLoopState(bool flagLoop){

    this->flagLoop = flagLoop;
}

jpl::_network::_socket::MainServerSocket::~MainServerSocket(){

    delete this->clientListController;
}

void jpl::_network::_socket::MainServerSocket::setClientListController(jpl::_network::_socket::ClientListController* clientListController){
    this->clientListController = clientListController;
}

std::string jpl::_network::_socket::getClientIp(jpl::_network::_socket::Client* client){
