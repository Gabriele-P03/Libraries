...
const jpl::_socket::MainSocket::MODE_SOCKET jpl::_socket::MainSocket::CLIENT_MODE_SOCKET = 0;
const jpl::_socket::MainSocket::MODE_SOCKET jpl::_socket::MainSocket::SERVER_MODE_SOCKET = 1;

//Client constructor part
jpl::_socket::MainSocket::MainSocket(std::string ip, unsigned int port) : jpl::_socket::MainSocket::MainSocket(ip, port, AF_INET, SOCK_STREAM, IPPROTO_TCP){}
jpl::_socket::MainSocket::MainSocket(std::string ip, unsigned int port, int domain, int type, int protocol){
    this->server_ip = ip;
    this->port = port;
...
jpl::_socket::MainSocket::MainSocket(unsigned int port) : jpl::_socket::MainSocket(port, AF_INET, SOCK_STREAM, IPPROTO_TCP){}
jpl::_socket::MainSocket::MainSocket(unsigned int port, int domain, int type, int protocol){
    this->port = port;
    this->server_ip = "";
...
int jpl::_socket::MainSocket::setSocket(){
...
void jpl::_socket::MainSocket::overrideNewError(){
...
jpl::_socket::MainSocket::~MainSocket(){
